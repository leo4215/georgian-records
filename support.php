...
<body>
    ...
    <main>
        <!-- First section with a background color and content -->
        ...
        <!-- Second section with a background color and a support form -->
        <section style="background-color: #1b2132;">
            <div class="support-form">
                ...
                <!-- Set the action attribute for the form and use the method "get" -->
                <form id="edit_info" action="process-form.php" method="get">
                    ...
                    <fieldset>
                        ...
                        <div>
                            ...
                            <!-- Add a select element for the subject with required attribute -->
                        ...
                        <div>
                            ...
                            <!-- Add a textarea element for the message with required attribute -->
                    ...
                    <fieldset class="support-review">
                        ...
                        <div class="stars">
                            <span>
                                <!-- Add a set of radio buttons for the review -->
